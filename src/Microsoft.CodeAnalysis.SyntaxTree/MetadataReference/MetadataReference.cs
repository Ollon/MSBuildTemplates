...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract class MetadataReference
    {
        ...
        {
            AssemblyMetadata metadata = AssemblyMetadata.CreateFromImage(peImage);
            ...
            string filePath = null)
        {
            ...
            AssemblyMetadata metadata = AssemblyMetadata.CreateFromStream(peStream, PEStreamOptions.PrefetchEntireImage);
            ...
            DocumentationProvider documentation = null)
        {
            ...
            ModuleMetadata module = ModuleMetadata.CreateFromStream(peStream, PEStreamOptions.PrefetchEntireImage);
            ...
            AssemblyMetadata assemblyMetadata = AssemblyMetadata.CreateFromFile(module, path);
            ...
            DocumentationProvider documentation = null)
        {
            ...
            AssemblyMetadata metadata = AssemblyMetadata.CreateFromStream(peStream);
