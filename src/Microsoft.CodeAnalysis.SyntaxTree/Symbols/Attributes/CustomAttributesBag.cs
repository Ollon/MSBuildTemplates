...
namespace Microsoft.CodeAnalysis
{
        ...
        where T : AttributeData
    {
        ...
        public bool SetEarlyDecodedWellKnownAttributeData(EarlyWellKnownAttributeData data)
        {
            ...
            bool setOnOurThread = Interlocked.CompareExchange(ref _earlyDecodedWellKnownAttributeData, data, null) == null;
        ...
        {
            WellKnownAttributeData.Seal(data);
            bool setOnOurThread = Interlocked.CompareExchange(ref _decodedWellKnownAttributeData, data, null) == null;
        ...
        public bool SetAttributes(ImmutableArray<T> newCustomAttributes)
        {
            ...
            bool setOnOurThread = ImmutableInterlocked.InterlockedCompareExchange(ref _customAttributes, newCustomAttributes, default(ImmutableArray<T>)) == default(ImmutableArray<T>);
