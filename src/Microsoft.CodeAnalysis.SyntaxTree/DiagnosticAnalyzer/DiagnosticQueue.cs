...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal abstract class DiagnosticQueue
    {
        ...
        private sealed class CategorizedDiagnosticQueue : DiagnosticQueue
        {
            ...
            {
                if (diagnosticsMap.TryGetValue(analyzer, out SimpleDiagnosticQueue queue))
                {
            ...
            {
                if (TryGetDiagnosticsQueue(analyzer, diagnosticsMap, out SimpleDiagnosticQueue queue))
                {
