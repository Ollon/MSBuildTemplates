    ...
    internal partial class SuppressMessageAttributeState
    {
        ...
        private struct TargetSymbolResolver
        {
            ...
            public void Resolve(IList<ISymbol> results)
            {
                ...
                string nameWithoutPrefix = RemovePrefix(_name, s_suppressionPrefix);
                ...
                while (true)
                {
                    string segment = ParseNextNameSegment();
            ...
            private TypeInfo? ParseIndexedTypeParameter(ISymbol bindingContext)
            {
                ...
                if (PeekNextChar() == '!')
                {
                    ...
                    ++_index;
                    int methodTypeParameterIndex = ReadNextInteger();

                    IMethodSymbol methodContext = bindingContext as IMethodSymbol;
                ...
                int typeParameterIndex = ReadNextInteger();
            ...
            private TypeInfo? ParseNamedTypeParameter(ISymbol bindingContext)
            {
                ...
                string typeParameterName = ParseNextNameSegment();
            ...
            private TypeInfo[] ParseTypeArgumentList(ISymbol bindingContext)
            {
                ...
                ArrayBuilder<TypeInfo> builder = new ArrayBuilder<TypeInfo>();
            ...
            {
                ArrayBuilder<IMethodSymbol> builder = new ArrayBuilder<IMethodSymbol>();
