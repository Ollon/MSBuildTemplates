    ...
    internal abstract class GreenNode : IObjectWritable
    {
        ...
        internal GreenNode(ObjectReader reader)
        {
            ...
            if ((kindBits & ExtendedSerializationInfoMask) != 0)
            {
                ...
                SyntaxAnnotation[] annotations = (SyntaxAnnotation[])reader.ReadValue();
        ...
        {
            ushort kindBits = (UInt16)_kind;
            bool hasDiagnostics = this.GetDiagnostics().Length > 0;
            bool hasAnnotations = this.GetAnnotations().Length > 0;
        ...
        public virtual string ToFullString()
        {
            ...
            StringWriter writer = new System.IO.StringWriter(sb.Builder, System.Globalization.CultureInfo.InvariantCulture);
        ...
        protected internal void WriteTo(TextWriter writer, bool leading, bool trailing)
        {
            ...
            Stack<(GreenNode node, bool leading, bool trailing)> stack = new Stack<(GreenNode node, bool leading, bool trailing)>();
            ...
            Stack<(GreenNode node, bool leading, bool trailing)> stack)
        {
            while (stack.Count > 0)
            {
                ...
                GreenNode currentNode = current.Item1;
                bool currentLeading = current.Item2;
                bool currentTrailing = current.Item3;
                ...
                int firstIndex = GetFirstNonNullChildIndex(currentNode);
                int lastIndex = GetLastNonNullChildIndex(currentNode);
