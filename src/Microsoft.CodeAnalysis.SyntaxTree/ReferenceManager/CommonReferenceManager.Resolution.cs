...
namespace Microsoft.CodeAnalysis
{
        ...
        where TAssemblySymbol : class, IAssemblySymbolInternal
    {
            ...
            DiagnosticBag diagnostics)
        {
            ...
            ResolvedReference[] referenceMap = new ResolvedReference[referenceCount];
            ...
            Dictionary<MetadataReference, MetadataReference> boundReferences = new Dictionary<MetadataReference, MetadataReference>(MetadataReferenceEqualityComparer.Instance);
            ...
            ArrayBuilder<AssemblyData> assembliesBuilder = ArrayBuilder<AssemblyData>.GetInstance();
            ...
            for (int referenceIndex = referenceCount - 1; referenceIndex >= 0; referenceIndex--)
            {
                ...
                CompilationReference compilationReference = boundReference as CompilationReference;
                ...
                PortableExecutableReference peReference = (PortableExecutableReference)boundReference;
        ...
        private Metadata GetMetadata(PortableExecutableReference peReference, CommonMessageProvider messageProvider, Location location, DiagnosticBag diagnostics)
        {
            ...
            try
            {
                ...
                AssemblyMetadata assemblyMetadata = newMetadata as AssemblyMetadata;
        ...
        {
            if (ObservedMetadata.TryGetValue(peReference, out object existing))
            {
        ...
        internal sealed class MetadataReferenceEqualityComparer : IEqualityComparer<MetadataReference>
        {
            ...
            public bool Equals(MetadataReference x, MetadataReference y)
            {
                ...
                CompilationReference cx = x as CompilationReference;
                if (cx != null)
                {
                    CompilationReference cy = y as CompilationReference;
                    if (cy != null)
                    {
            ...
            {
                CompilationReference compilationReference = reference as CompilationReference;
                if (compilationReference != null)
                {
        ...
        {
            ReferencedAssemblyIdentity referencedAssembly = new ReferencedAssemblyIdentity(identity, reference, assemblyIndex);
        ...
        {
            AssemblyReferenceBinding[] boundReferences = new AssemblyReferenceBinding[references.Length];
