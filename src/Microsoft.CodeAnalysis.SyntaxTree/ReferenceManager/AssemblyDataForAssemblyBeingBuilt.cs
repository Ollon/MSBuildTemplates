    ...
    internal partial class CommonReferenceManager<TCompilation, TAssemblySymbol>
    {
        protected sealed class AssemblyDataForAssemblyBeingBuilt : AssemblyData
        {
                ...
                ImmutableArray<PEModule> modules)
            {
                ...
                ArrayBuilder<AssemblyIdentity> refs = ArrayBuilder<AssemblyIdentity>.GetInstance(referencedAssemblyData.Length + modules.Length); //approximate size
            ...
            {
                AssemblyReferenceBinding[] boundReferences = new AssemblyReferenceBinding[_referencedAssemblies.Length];
