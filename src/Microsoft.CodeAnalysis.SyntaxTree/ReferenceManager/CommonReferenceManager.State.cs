...
namespace Microsoft.CodeAnalysis
{
    ...
    internal partial class CommonReferenceManager<TCompilation, TAssemblySymbol> : CommonReferenceManager
    {
            ...
            out ImmutableArray<ImmutableArray<string>> aliasesOfReferencedAssemblies)
        {
            ...
            ArrayBuilder<ImmutableArray<string>> aliasesOfReferencedAssembliesBuilder = ArrayBuilder<ImmutableArray<string>>.GetInstance(referenceMap.Length - referencedModuleCount);
        ...
        {
            ArrayBuilder<int> assemblyIndicesToProcess = ArrayBuilder<int>.GetInstance();
            BitVector visitedAssemblies = BitVector.Create(bindingResult.Length);
