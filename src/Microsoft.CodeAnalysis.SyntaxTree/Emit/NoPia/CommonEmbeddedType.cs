        ...
        internal abstract class CommonEmbeddedType : Cci.INamespaceTypeDefinition
        {
            ...
            IEnumerable<Cci.IEventDefinition> Cci.ITypeDefinition.Events
            {
                get
                {
                    if (_lazyEvents.IsDefault)
                    {
                        ...
                        ArrayBuilder<Cci.IEventDefinition> builder = ArrayBuilder<Cci.IEventDefinition>.GetInstance();
            ...
            IEnumerable<Cci.IFieldDefinition> Cci.ITypeDefinition.GetFields(EmitContext context)
            {
                if (_lazyFields.IsDefault)
                {
                    ...
                    ArrayBuilder<Cci.IFieldDefinition> builder = ArrayBuilder<Cci.IFieldDefinition>.GetInstance();
            ...
            IEnumerable<Cci.IMethodDefinition> Cci.ITypeDefinition.GetMethods(EmitContext context)
            {
                if (_lazyMethods.IsDefault)
                {
                    ...
                    ArrayBuilder<Cci.IMethodDefinition> builder = ArrayBuilder<Cci.IMethodDefinition>.GetInstance();
            ...
            IEnumerable<Cci.IPropertyDefinition> Cci.ITypeDefinition.GetProperties(EmitContext context)
            {
                if (_lazyProperties.IsDefault)
                {
                    ...
                    ArrayBuilder<Cci.IPropertyDefinition> builder = ArrayBuilder<Cci.IPropertyDefinition>.GetInstance();
            ...
            IEnumerable<Cci.ICustomAttribute> Cci.IReference.GetAttributes(EmitContext context)
            {
                if (_lazyAttributes.IsDefault)
                {
                    ...
                    ImmutableArray<TAttributeData> attributes = GetAttributes((TModuleCompilationState)context.Module.CommonModuleCompilationState, (TSyntaxNode)context.SyntaxNodeOpt, diagnostics);
