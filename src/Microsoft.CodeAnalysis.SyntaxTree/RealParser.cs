...
namespace Microsoft.CodeAnalysis
{
    ...
    internal static class RealParser
    {
        ...
        private static BigInteger AccumulateDecimalDigitsIntoBigInteger(DecimalFloatingPointString data, uint integer_first_index, uint integer_last_index)
        {
            ...
            string valueString = data.Mantissa.Substring((int)integer_first_index, (int)(integer_last_index - integer_first_index));
        ...
        {
            BigInteger powerOfTwo = BigInteger.Pow(s_bigTwo, (int)shift);
        ...
        {
            BigInteger powerOfTen = BigInteger.Pow(s_bigTen, (int)power);
