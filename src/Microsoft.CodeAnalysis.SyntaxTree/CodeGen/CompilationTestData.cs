...
namespace Microsoft.CodeAnalysis.CodeGen
{
    internal sealed class CompilationTestData
    {
        ...
        public ImmutableDictionary<string, MethodData> GetMethodsByName()
        {
            ...
            {
                Dictionary<string, MethodData> map = new Dictionary<string, MethodData>();
                foreach (KeyValuePair<IMethodSymbol, MethodData> pair in Methods)
                {
                    string name = GetMethodName(pair.Key);
                ...
                ImmutableDictionary<string, MethodData> methodsByName = map.Where(p => p.Value.Method != null).ToImmutableDictionary();
