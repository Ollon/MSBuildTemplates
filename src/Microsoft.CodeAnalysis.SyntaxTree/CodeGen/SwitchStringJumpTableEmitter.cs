...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    internal struct SwitchStringJumpTableEmitter
    {
        ...
        private Dictionary<uint, object> EmitHashBucketJumpTable(Dictionary<uint, HashBucket> stringHashMap)
        {
            ...
            Dictionary<uint, object> hashBucketLabelsMap = new Dictionary<uint, object>(count);
            KeyValuePair<ConstantValue, object>[] jumpTableLabels = new KeyValuePair<ConstantValue, object>[count];
            int i = 0;
            ...
            SwitchIntegralJumpTableEmitter hashBucketJumpTableEmitter = new SwitchIntegralJumpTableEmitter(
                builder: _builder,
