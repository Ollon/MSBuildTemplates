...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    internal class ArrayMethods
    {
        ...
        {
            (byte, Cci.IArrayTypeReference) key = ((byte)id, arrayType);
        ...
        private sealed class ArraySet : ArrayMethod
        {
            ...
            protected override ImmutableArray<ArrayMethodParameterInfo> MakeParameters()
            {
                ...
                ArrayBuilder<ArrayMethodParameterInfo> parameters = ArrayBuilder<ArrayMethodParameterInfo>.GetInstance(rank + 1);
    ...
    internal abstract class ArrayMethod : Cci.IMethodReference
    {
        ...
        {
            int rank = (int)arrayType.Rank;
            ArrayBuilder<ArrayMethodParameterInfo> parameters = ArrayBuilder<ArrayMethodParameterInfo>.GetInstance(rank);
