...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    internal sealed class PrivateImplementationDetails : DefaultTypeDef, Cci.INamespaceTypeDefinition
    {
        ...
        internal Cci.IFieldReference CreateDataField(ImmutableArray<byte> data)
        {
            ...
            {
                string name = GenerateDataFieldName(data0);
                MappedField newField = new MappedField(name, this, type, data0);
                return newField;
            });
        }
        ...
        {
            ImmutableArray<byte> hash = CryptographicHashProvider.ComputeSha1(data);
