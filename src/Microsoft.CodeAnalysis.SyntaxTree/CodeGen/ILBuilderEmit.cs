...
namespace Microsoft.CodeAnalysis.CodeGen
{
    internal partial class ILBuilder
    {
            ...
            SwitchStringJumpTableEmitter.GetStringHashCode computeStringHashcodeDelegate)
        {
            ...
            SwitchStringJumpTableEmitter emitter = new SwitchStringJumpTableEmitter(
                this,
                key,
                caseLabels,
                fallThroughLabel,
            ...
            Cci.PrimitiveTypeCode keyTypeCode)
        {
            ...
            SwitchIntegralJumpTableEmitter emitter = new SwitchIntegralJumpTableEmitter(this, caseLabels, fallThroughLabel, keyTypeCode, key);
            emitter.EmitJumpTable();
        }
