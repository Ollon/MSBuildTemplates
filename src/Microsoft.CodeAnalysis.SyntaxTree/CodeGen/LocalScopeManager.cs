...
namespace Microsoft.CodeAnalysis.CodeGen
{
    internal partial class ILBuilder
    {
        private sealed class LocalScopeManager
        {
            ...
            {
                ArrayBuilder<Cci.ExceptionHandlerRegion> result = ArrayBuilder<Cci.ExceptionHandlerRegion>.GetInstance();
            ...
            {
                ArrayBuilder<StateMachineHoistedLocalScope> result = ArrayBuilder<StateMachineHoistedLocalScope>.GetInstance();
        ...
        internal class LocalScopeInfo : ScopeInfo
        {
            ...
            internal override ScopeBounds GetLocalScopes(ArrayBuilder<Cci.LocalScope> result)
            {
                ...
                {
                    Cci.LocalScope newScope = new Cci.LocalScope(
                        begin,
                        end,
            ...
            internal override ScopeBounds GetHoistedLocalScopes(ArrayBuilder<StateMachineHoistedLocalScope> result)
            {
                ...
                {
                    StateMachineHoistedLocalScope newScope = new StateMachineHoistedLocalScope(begin, end);

                    foreach (int slotIndex in _stateMachineUserHoistedLocalSlotIndices)
                    {
        ...
        internal sealed class ExceptionHandlerContainerScope : ScopeInfo
        {
                ...
                ExceptionHandlerScope currentExceptionHandler)
            {
                ...
                ExceptionHandlerScope handler = new ExceptionHandlerScope(this, scopeType, exceptionType);
        ...
        private sealed class ScopeComparer : IComparer<Cci.LocalScope>
        {
            ...
            {
                int result = x.StartOffset.CompareTo(y.StartOffset);
