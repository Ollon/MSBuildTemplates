    ...
    internal static class CorLightup
    {
        internal static class Desktop
        {
            ...
            internal static bool? IsUserCustomCulture(CultureInfo cultureInfo)
            {
                ...
                try
                {
                    int value = (int)_CultureInfo.CultureTypes.GetValue(cultureInfo);
            ...
            private sealed class AssemblyResolveWrapper
            {
                ...
                {
                    string name = (string)_ResolveEventArgs.get_Name.Invoke(resolveEventArgs, Array.Empty<object>());
                    Assembly requestingAssembly = (Assembly)_ResolveEventArgs.get_RequestingAssembly.Invoke(resolveEventArgs, Array.Empty<object>());
