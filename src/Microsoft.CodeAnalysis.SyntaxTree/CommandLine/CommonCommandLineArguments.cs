...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract class CommandLineArguments
    {
            ...
            IAnalyzerAssemblyLoader analyzerLoader)
        {
            ...
            {
                AnalyzerFileReference analyzerReference = o as AnalyzerFileReference;
            ...
            ArrayBuilder<AnalyzerFileReference> resolvedReferences = ArrayBuilder<AnalyzerFileReference>.GetInstance();
