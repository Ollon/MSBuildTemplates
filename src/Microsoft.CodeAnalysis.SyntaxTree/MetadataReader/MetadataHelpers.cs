...
namespace Microsoft.CodeAnalysis
{
    internal static class MetadataHelpers
    {
        ...
        {
            SerializedTypeDecoder decoder = new SerializedTypeDecoder(s);
              ...
              string name)
        {
            ...
            ArrayBuilder<string> result = ArrayBuilder<string>.GetInstance(dots + 1);
            ...
            out IEnumerable<KeyValuePair<string, IEnumerable<IGrouping<string, TypeDefinitionHandle>>>> namespaces)
        {
            ...
            List<IGrouping<string, TypeDefinitionHandle>> nestedTypes = new List<IGrouping<string, TypeDefinitionHandle>>();
            ...
            //   Value – contains a sequence similar to the one passed to this function, but
            //           calculated for the child namespace. 
            List<KeyValuePair<string, IEnumerable<IGrouping<string, TypeDefinitionHandle>>>> nestedNamespaces = new List<KeyValuePair<string, IEnumerable<IGrouping<string, TypeDefinitionHandle>>>>();
            ...
            {
                Dictionary<string, int> names = new Dictionary<string, int>(nestedNamespaces.Count, nameComparer);
