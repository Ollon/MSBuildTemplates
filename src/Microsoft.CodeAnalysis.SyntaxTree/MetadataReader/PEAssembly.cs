...
namespace Microsoft.CodeAnalysis
{
    internal sealed class PEAssembly
    {
        ...
        internal PEAssembly(AssemblyMetadata owner, ImmutableArray<PEModule> modules)
        {
            ...
            ArrayBuilder<AssemblyIdentity> refs = ArrayBuilder<AssemblyIdentity>.GetInstance();
        ...
        {
            Dictionary<string, List<ImmutableArray<byte>>> ivtMap = new Dictionary<string, List<ImmutableArray<byte>>>(StringComparer.OrdinalIgnoreCase);
