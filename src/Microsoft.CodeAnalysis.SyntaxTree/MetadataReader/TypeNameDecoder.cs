...
namespace Microsoft.CodeAnalysis
{
        ...
        where TypeSymbol : class
    {
        ...
        internal TypeSymbol GetTypeSymbol(MetadataHelpers.AssemblyQualifiedTypeName fullName, out bool refersToNoPiaLocalType)
        {
            ...
            MetadataTypeName mdName = MetadataTypeName.FromFullName(fullName.TopLevelType);
            ...
            {
                ImmutableArray<KeyValuePair<TypeSymbol, ImmutableArray<ModifierInfo<TypeSymbol>>>> typeArguments = ResolveTypeArguments(fullName.TypeArguments, out ImmutableArray<bool> argumentRefersToNoPiaLocalType);
        ...
        private ImmutableArray<KeyValuePair<TypeSymbol, ImmutableArray<ModifierInfo<TypeSymbol>>>> ResolveTypeArguments(MetadataHelpers.AssemblyQualifiedTypeName[] arguments, out ImmutableArray<bool> refersToNoPiaLocalType)
        {
            ...
            ArrayBuilder<KeyValuePair<TypeSymbol, ImmutableArray<ModifierInfo<TypeSymbol>>>> typeArgumentsBuilder = ArrayBuilder<KeyValuePair<TypeSymbol, ImmutableArray<ModifierInfo<TypeSymbol>>>>.GetInstance(count);
            ArrayBuilder<bool> refersToNoPiaBuilder = ArrayBuilder<bool>.GetInstance(count);
