...
namespace Microsoft.Cci
{
    internal abstract partial class MetadataWriter
    {
        ...
        {
            IEnumerable<IReference> referencesInIL = module.ReferencesInIL(out int count);
        ...
        {
            Queue<ITypeDefinition> nestedTypes = new Queue<ITypeDefinition>();
        ...
        {
            if (_customAttributeSignatureIndex.TryGetValue(customAttribute, out BlobHandle result))
            {
                return result;
            }

            PooledBlobBuilder writer = PooledBlobBuilder.GetInstance();
        ...
        {
            FieldAttributes result = (FieldAttributes)fieldDef.Visibility;
        ...
        internal BlobHandle GetFieldSignatureIndex(IFieldReference fieldReference)
        {
            ...
            if (_fieldSignatureIndex.TryGetValue(fieldReference, out BlobHandle result))
            {
                return result;
            }
        ...
        internal AssemblyFileHandle GetAssemblyFileHandle(IFileReference fileReference)
        {
            ...
            if (!_fileRefIndex.TryGetValue(key, out int index))
            {
                Debug.Assert(!_tableIndicesAreComplete);
        ...
        private EntityHandle GetExportedTypeImplementation(INamespaceTypeReference namespaceRef)
        {
            ...
            IModuleReference mref = (IModuleReference)uref;
        ...
        internal EntityHandle GetMemberReferenceParent(ITypeMemberReference memberRef)
        {
            ...
            {
                TryGetTypeDefinitionHandle(parentTypeDef, out TypeDefinitionHandle parentTypeDefHandle);
        ...
        {
            MethodAttributes result = (MethodAttributes)methodDef.Visibility;
        ...
        {
            if (_methodInstanceSignatureIndex.TryGetValue(methodInstanceReference, out BlobHandle result))
            {
                return result;
            }

            PooledBlobBuilder builder = PooledBlobBuilder.GetInstance();
        ...
        {
            if (_marshallingDescriptorIndex.TryGetValue(marshallingInformation, out BlobHandle result))
            {
                return result;
            }
        ...
        {
            GetMethodSignatureHandleAndBlob(methodReference, out ImmutableArray<byte> signatureBlob);
        ...
        private BlobHandle GetMethodSignatureHandleAndBlob(IMethodReference methodReference, out ImmutableArray<byte> signatureBlob)
        {
            ...
            if (_signatureIndex.TryGetValue(methodReference, out KeyValuePair<BlobHandle, ImmutableArray<byte>> existing))
            {
        ...
        internal EntityHandle GetMethodHandle(IMethodReference methodReference)
        {
            ...
            if (methodDef != null && (methodReference == methodDef || !methodReference.AcceptsExtraArguments) && this.TryGetMethodDefinitionHandle(methodDef, out MethodDefinitionHandle methodDefHandle))
            {
        ...
        {
            if (_signatureIndex.TryGetValue(propertyDef, out KeyValuePair<BlobHandle, ImmutableArray<byte>> existing))
            {
                return existing.Key;
            }
            ...
            ImmutableArray<byte> blob = builder.ToImmutableArray();
        ...
        private EntityHandle GetResolutionScopeHandle(IUnitReference unitReference)
        {
            ...
            IModuleReference mref = (IModuleReference)unitReference;
            aref = mref.GetContainingAssembly(Context);
        ...
        {
            if (this.TryGetTypeRefeferenceHandle(typeReference, out TypeReferenceHandle result))
            {
                return result;
            }
        ...
        {
            if (_typeSpecSignatureIndex.TryGetValue(typeReference, out BlobHandle result))
            {
                return result;
            }
        ...
        internal EntityHandle GetTypeHandle(ITypeReference typeReference, bool treatRefAsPotentialTypeSpec = true)
        {
            ...
            if (typeDefinition != null && this.TryGetTypeDefinitionHandle(typeDefinition, out TypeDefinitionHandle handle))
            {
                return handle;
            }
        ...
        public void WriteMetadataAndIL(PdbWriter nativePdbWriterOpt, Stream metadataStream, Stream ilStream, Stream portablePdbStreamOpt, out MetadataSizes metadataSizes)
        {
            ...
            BlobBuilder ilBuilder = new BlobBuilder(1024);
            BlobBuilder metadataBuilder = new BlobBuilder(4 * 1024);
            ...
            MetadataRootBuilder rootBuilder = new MetadataRootBuilder(metadata, module.SerializationProperties.TargetRuntimeVersion, suppressValidation: true);
        ...
        private int SerializeMethodBody(MethodBodyStreamEncoder encoder, IMethodBody methodBody, StandaloneSignatureHandle localSignatureHandleOpt, ref UserStringHandle mvidStringHandle, ref Blob mvidStringFixup)
        {
            ...
            if (!_deterministic && isSmallBody && _smallMethodBodies.TryGetValue(methodBody.IL, out int bodyOffset))
            {
                return bodyOffset;
            }
        ...
        private UserStringHandle ResolveUserStringHandleFromPseudoToken(int pseudoStringToken)
        {
            ...
            string str = _pseudoStringTokenToStringMap[index];
            if (str != null)
            {
        ...
        private void WriteInstructions(Blob finalIL, ImmutableArray<byte> generatedIL, ref UserStringHandle mvidStringHandle, ref Blob mvidStringFixup)
        {
            ...
            BlobWriter writer = new BlobWriter(finalIL);
        ...
        private void SerializeCustomAttributeNamedArguments(NamedArgumentsEncoder encoder, ICustomAttribute customAttribute)
        {
            ...
            {
                encoder.AddArgument(namedArgument.IsField, out NamedArgumentTypeEncoder typeEncoder, out NameEncoder nameEncoder, out LiteralEncoder literalEncoder);
        ...
        {
            MetadataCreateArray a = expression as MetadataCreateArray;
            if (a != null)
            {
                ITypeReference targetElementType;
                IArrayTypeReference targetArrayType = targetType as IArrayTypeReference;
                ...
                if (targetArrayType == null)
                {
                    ...
                    encoder.TaggedVector(out CustomAttributeArrayTypeEncoder arrayTypeEncoder, out vectorEncoder);
            ...
            else
            {
                ...
                {
                    encoder.TaggedScalar(out CustomAttributeElementTypeEncoder typeEncoder, out scalarEncoder);
        ...
        private void SerializeMarshallingDescriptor(IMarshallingInformation marshallingInformation, BlobBuilder writer)
        {
            ...
            switch (marshallingInformation.UnmanagedType)
            {
                ...
                case Constants.UnmanagedType_CustomMarshaler:
                    ...
                    string arg = marshallingInformation.CustomMarshallerRuntimeArgument;
                    if (arg != null)
                    {
        ...
        private void SerializePermissionSet(IEnumerable<ICustomAttribute> permissionSet, BlobBuilder writer)
        {
            ...
            foreach (ICustomAttribute customAttribute in permissionSet)
            {
                ...
                if (!isAssemblyQualified)
                {
                    ...
                    IAssemblyReference referencedAssembly = namespaceType?.GetUnit(context) as IAssemblyReference;
                ...
                PooledBlobBuilder customAttributeArgsBuilder = PooledBlobBuilder.GetInstance();
        ...
        private void SerializeReturnValueAndParameters(MethodSignatureEncoder encoder, ISignature signature, ImmutableArray<IParameterTypeInformation> varargParameters)
        {
            ...
            encoder.Parameters(declaredParameters.Length + varargParameters.Length, out ReturnTypeEncoder returnTypeEncoder, out ParametersEncoder parametersEncoder);
        ...
        private void SerializeTypeReference(SignatureTypeEncoder encoder, ITypeReference typeReference)
        {
            while (true)
            {
                ...
                if (arrayTypeReference != null)
                {
                    ...
                    {
                        encoder.Array(out SignatureTypeEncoder elementType, out ArrayShapeEncoder arrayShape);
        ...
        protected abstract class HeapOrReferenceIndexBase<T>
        {
            ...
            {
                if (!this.TryGetValue(item, out int index))
                {
                    index = Add(item);
                }
