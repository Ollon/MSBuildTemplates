// -----------------------------------------------------------------------
// <copyright file="VsEnvDTE2.cs" company="Ollon, LLC">
...
{
    [Export(typeof(DTE2))]
    internal sealed class VsEnvDTE2 : DTE2
    {
        ...
        public VsEnvDTE2(DTE2 dte)
        {
            _dte = dte;
        }

        [ImportingConstructor]
        private VsEnvDTE2([Import(typeof(SVsServiceProvider))] IServiceProvider serviceProvider)
            : this(serviceProvider.GetService(typeof(SDTE)) as DTE2)
        {
        }
    }
}
