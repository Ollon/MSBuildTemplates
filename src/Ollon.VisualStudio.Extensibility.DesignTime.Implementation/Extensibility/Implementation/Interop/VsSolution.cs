// -----------------------------------------------------------------------
// <copyright file="VsSolution.cs" company="Ollon, LLC">
...
{
    [Export(typeof(IVsSolution))]
    internal sealed class VsSolution : IVsSolution
    {
        ...
        public VsSolution(IVsSolution solution)
        {
            _solution = solution;
        }

        [ImportingConstructor]
        private VsSolution([Import(typeof(SVsServiceProvider))] IServiceProvider serviceProvider)
