// -----------------------------------------------------------------------
// <copyright file="VsSolution2.cs" company="Ollon, LLC">
...
namespace Ollon.VisualStudio.Extensibility.Implementation.Interop
{
    ...
    internal sealed class VsSolution2 : IVsSolution2
    {
        ...
        private VsSolution2([Import(typeof(SVsServiceProvider))] IServiceProvider serviceProvider)
            : this(serviceProvider.GetService(typeof(SVsSolution)) as IVsSolution2)
        {
        }
    }
}
